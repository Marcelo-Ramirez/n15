...
INSERT INTO "new_inventory_movements" ("created_at", "id", "ingredient_id", "movement_date", "movement_type", "new_quantity", "previous_quantity", "quantity", "reason", "total_cost", "unit_price", "user_id") SELECT "created_at", "id", "ingredient_id", "movement_date", "movement_type", "new_quantity", "previous_quantity", "quantity", "reason", "total_cost", "unit_price", "user_id" FROM "inventory_movements";
